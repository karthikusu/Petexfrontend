...
//     try {
//       const response = await fetch('http://localhost:1114/api/grooming/all');
...
//   return (
//     <div className="containergrooming">
...
//           <Col key={item.id}>
//             <Card>
//               <Card.Img variant="top" src="https://insights.workwave.com/wp-content/uploads/2023/03/pretty-westhighland-terrier-puppy-and-hands-with-groomer-tools-isolated-on-white.jpg_s1024x1024wisk20cde9rkIMhmG7MHJTO3fMOhYThJrnc2-Qf65sZhcOQIzs.jpg" /> {/* Use dynamic image URL */}
//               <Card.Body>
