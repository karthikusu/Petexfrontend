    ...
    <div className="container" id="container">
      ...
      <div className="adminsidebar" >
        <div className="iconic">
          ...
          <a href="/doctorreport"><i className="fa fa-dog"></i>Doctor Reports</a>
          <a href="/pettypesform"><i className="fa fa-dog"></i> Pet Types</a>
          <a href="/Sellingreport"><i className="fa fa-chart-line"></i> Selling Reports</a>
          <a href="/adminservices"><i className="fa fa-home"></i> Services</a>
          <a href="/user"><i className="fa fa-person"></i> Users</a>
