...
<div className="iconic">
    ...
    {/* <a href="/usertrainingnavbar"  style={{ textDecoration: "none", color: "#ebece2", display: "block", padding: "15px 20px", transition: "all 0.25s", }}><i className="fa fa-training" style={{ fontSize: "20px", transition: "all 0.25s", }}></i> Training</a> */}
