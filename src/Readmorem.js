...
function Readmores(){
  ...
  const handleFormSubmit = (e) => {
    ...
    return(
        ...
        <Navpet/>
        <div>
            <img src="https://images.pexels.com/photos/7882334/pexels-photo-7882334.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" style={{ width : "100%", marginTop : "1%", borderRadius : "2rem"}} alt=".."/>
        </div>
        <div className="Readmore" style={{ marginTop : "5rem"}}>
        <div class="service-item bg-light d-flex p-4" style={{ display : "flex"}}>
                        <div>
                            <h1 class="text-uppercase mb-3" style={{ marginLeft : "10%", fontSize : "4rem"}}>Pet Grooming</h1>
                        ...
                        <div>
                            <img style={{ width : "250%",border : "1px solid", borderRadius : "5rem", height : '70vh', marginRight : "10%", marginLeft : "-170%"}} src="https://images.pexels.com/photos/6816853/pexels-photo-6816853.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="..."/>
                        </div>
                    </div>
                    <br/>
                    </div>
...
service and we always try to give all the answer of their questions. Before taking services it is important to know about the service process and its advantages or disadvantages. Here is some questions and answers we set as standard.</p>
        ...
        <div style={{ display : "flex"}}>
            <div>
            <img src="https://images.pexels.com/photos/19145878/pexels-photo-19145878/free-photo-of-dog-groomer-brushing-a-dog.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" 
           style={{ marginLeft : "2%", width : "90%" , border : "1px solid", borderRadius : "5rem"}} alt=".."/>
           </div>
           <div>
            <h1>Pet- Grooming</h1>
            <h1 style={{ color : "darkmagenta"}}>$5-$10</h1>
        <label style={{ fontSize : "2rem", fontWeight : "bolder" }}>Grooming Services : </label><br/><br/>
