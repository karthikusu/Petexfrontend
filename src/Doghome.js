...
function Profiledog(){
  ...
  <p classname="card-text">Location:Hydarabad</p>
    ...
    <Link to="/userlogin"><button class="btn btn-primary" style={{marginLeft: "20px",fontFamily : "Arial, Helvetica", width: "8rem",height : "35px", borderRadius : "1rem",marginBottom : "2%", backgroundColor :"blue", fontSize : "1rem", color : "white"}}>Viewmore</button></Link>
  </div>
</div>
