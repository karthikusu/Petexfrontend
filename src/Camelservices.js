        ...
        <>
            ...
            <div style={{ display: "flex" }}>
                <div className="card-container">
                    <div className="card">
                    <img src="https://cdn.pixabay.com/photo/2020/06/07/19/15/morocco-5271734_1280.jpg" class="card-img-top" alt="..." style={{ width: "100%", height: "auto" }} />
                ...
                <div className="card-container">
                    <div className="card">
                    <img src="https://cdn.pixabay.com/photo/2023/01/20/13/00/bactrian-camel-7731688_960_720.jpg" class="card-img-top" alt="..." style={{ width: "100%", height: "auto" }} />
                            <div className="card-body">
                ...
                <div className="card-container">
                    <div className="card">
                    <img src="https://cdn.pixabay.com/photo/2013/03/21/07/42/saudi-arabia-95500_1280.jpg" class="card-img-top" alt="..." style={{ width: "100%", height: "auto" }} />
                            <div className="card-body">
            ...
            <div style={{ display: "flex" }}>
                <div className="card-container">
                    <div className="card">
                    <img src="https://cdn.pixabay.com/photo/2023/11/30/20/26/dry-8422373_1280.jpg" class="card-img-top" alt="..." style={{ width: "100%", height: "auto" }} />
                            <div className="card-body">
                ...
                <div className="card-container">
                    <div className="card">
                    <img src="https://cdn.pixabay.com/photo/2023/01/04/16/10/bactrian-camel-7697168_960_720.jpg" class="card-img-top" alt="..." style={{ width: "100%", height: "auto" }} />
                            <div className="card-body">
                ...
                <div className="card-container">
                    <div className="card">
                    <img src="https://cdn.pixabay.com/photo/2019/12/10/16/35/merzouga-4686151_1280.jpg" class="card-img-top" alt="..." style={{ width: "100%", height: "auto" }} />
                            <div className="card-body">
