...
const DogDog = () => {
    ...
    return(
        ...
        <div className="body">
                        ...
                        {dog.map(item => (
                            <div key={item.id} style={{padding:'20px'}}>
                                <div className="Dcards" style={{height:'650px', backgroundColor:'white'}}>
                                    <img className='Dcard_img' src="https://iheartdogs.com/wp-content/uploads/2019/01/puppy-1189067_640.jpg" style={{height:"400px", width:'370px',backgroundColor:'bisque',borderRadius:'50%'}} alt=""/>
            ...
            <div style={{backgroundColor:'#00a7b3', height:'120px'}}>
