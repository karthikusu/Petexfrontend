            ...
            <div className="col-md-2 col-sm-4" style={{ display: "flex" }}>
              ...
              <div className="col-md-5 col-sm-8">
                <div className="doc-info-cont" style={{ paddingRight: 30 }}>
                  <a href="/madhu" style={{cursor:"pointer", textDecoration:"none"}}><h2 className="htitle">Dr Madhu</h2></a>
        ...
        >
          <div className="row">
            <div className="col-md-2 col-sm-4" style={{ display: "flex" }}>
              ...
              <div className="col-md-5 col-sm-8">
                <div className="doc-info-cont" style={{ paddingRight: 30 }}>
                <a href="/mishra" style={{cursor:"pointer", textDecoration:"none"}}><h2 className="htitle">Dr Mishra</h2></a>
                  <p className="doc-department">Vetonary, MD (Internal Medicine)</p>
                  <p className="doc-department">Consultant General Physician</p>
                  <p className="doc-experience">
                    Experience :<span className="notranslate"> 15</span>+ Years
        ...
        >
          <div className="row">
            <div className="col-md-2 col-sm-4" style={{ display: "flex" }}>
              ...
              <div className="col-md-5 col-sm-8">
                <div className="doc-info-cont" style={{ paddingRight: 30 }}>
                <a href="/nandan" style={{cursor:"pointer", textDecoration:"none"}}><h2 className="htitle">Dr Nandan Jasti</h2></a>
                  <p className="doc-department">Vetonary, MD (Internal Medicine)</p>
                  <p className="doc-department">Consultant General Physician</p>
                  <p className="doc-experience">
                    Experience :<span className="notranslate"> 15</span>+ Years
