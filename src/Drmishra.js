...
function Drmishra(){
  ...
  <div className="DoctorProfileCard_info__Oiilv">
    <div className="DoctorProfileCard_row__ChdwW">
      <h1
        className="td sd
DoctorProfileCard_doctorName__3YCKI
...
"
    ...
    <div className="DoctorProfileCard_mobileRow__TKq2D">
      <h2
        className="ud sd
DoctorProfileCard_specialty__9MYzI

Fd
Nd" style={{ marginRight : "90%"}}
      >
        Petsurgern
      </h2>
      ...
      <div className="DoctorProfileCard_row__ChdwW">
        <h3
          className="vd sd
DoctorProfileCard_experience__mhy22
...
Od"
        ...
        <p
          className="zd sd
DoctorProfileCard_divider__Aj4Ns
...
Nd"
        ...
        <div className="DoctorProfileCard_recommendation__XSQno">
          ...
          <h3
            className="vd sd
DoctorProfileCard_rating__fAnjp
    ...
    <div className="DoctorProfileCard_addressBox__OUwET">
      ...
      <div className="DoctorProfileCard_addressInfo__LQMf5">
        <div className="DoctorProfileCard_row__ChdwW">
          <h3
            className="vd sd
DoctorProfileCard_clinicName__Y4amb

Gd
Nd"
          >
            Pet Hospitals Jubilee Hills
          </h3>
        </div>
        <h4
          className="wd sd
DoctorProfileCard_address__sekEZ

Hd
Pd"
        >
          Pet Hospitals Jubilee Hills, Rd Number 72, Opposite Bharatiya Vidya
          Bhavan School, Film Nagar Telangana{" "}
        </h4>
      </div>
    </div>
