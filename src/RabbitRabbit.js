                ...
                <div style={{display:'flex'}}>
                    <div style={{padding:'20px'}}>
                        <div className="Dcards" style={{height:'600px', backgroundColor:'white'}}>
                            <img  className='card_img' src="https://images.unsplash.com/photo-1585110396000-c9ffd4e4b308?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cmFiYml0fGVufDB8fDB8fHww" style={{height:"300px", width:'290px',backgroundColor:'bisque',borderRadius:'50%'}} alt=""/>
                    ...
                    <div style={{padding:'20px'}}>
                        <div className="Dcards" style={{height:'600px', backgroundColor:'white'}}>
                            <img className='card_img' src="https://images.unsplash.com/photo-1533514114760-4389f572ae26?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fHdoaXRlJTIwcmFiYml0fGVufDB8fDB8fHww" style={{height:"300px", width:'290px',backgroundColor:'bisque',borderRadius:'50%'}} alt=""/>
                            <div style={{padding:'30px'}}>
                    ...
                    <div style={{padding:'20px'}}>
                        <div className="Dcards" style={{height:'600px', backgroundColor:'white'}}>
                            <img className='card_img' src="https://i.pinimg.com/originals/f7/2e/cc/f72eccdfeae04bf1910c21f6692e5915.jpg" style={{height:"300px", width:'290px',backgroundColor:'bisque', borderRadius:'50%',margin:'auto', overflow:'hidden4'}} alt=""/>
                            <div style={{padding:'30px'}}>
