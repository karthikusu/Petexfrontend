  ...
  return (
    <div className="backgroundContainer" style={{ backgroundImage: `url(${BG2})`, height: "100vh", color:"white" }}>
      ...
      style={{backgroundColor:"transparent", width:"350px", height:"200px", marginLeft:"20%",borderRadius:"8px", marginTop:"100px", boxShadow:"0 4px 8px rgba(0, 0, 0, 0.8)"}}>
        ...
        style={{width:"300px", height:"35px", borderRadius:"5px", borderColor:"transparent", marginLeft:"10px", marginTop:"2%"}}/>
        <p>
        <button type="submit" 
        style={{backgroundColor:"red", borderColor:"transparent", borderRadius:"5px", height:"35px", marginLeft:"10px", marginTop:"5%"}}>Generate OTP</button>
