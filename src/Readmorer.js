...
function Readmorer(){
  ...
  const handleFormSubmit = (e) => {
    ...
    return(
        ...
        <Navpet/>
        <div>
            <img src="https://images.pexels.com/photos/17274722/pexels-photo-17274722/free-photo-of-close-up-of-colorul-macow-parrots.jpeg" style={{ width : "100%", marginTop : "1%", borderRadius : "2rem"}} alt=".."/>
        </div>
        <div className="Readmore" style={{ marginTop : "5rem"}}>
        <div class="service-item bg-light d-flex p-4" style={{ display : "flex"}}>
                        <div>
                            <h1 class="text-uppercase mb-3" style={{ marginLeft : "10%", fontSize : "4rem"}}>Pet Breeding</h1>
                        ...
                        <div>
                            <img style={{ width : "250%",border : "1px solid", borderRadius : "5rem", height : '70vh', marginRight : "10%", marginLeft : "-170%"}} src="https://images.pexels.com/photos/14515193/pexels-photo-14515193.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="..."/>
                        </div>
                    </div>
                    <br/>
                    </div>
...
service and we always try to give all the answer of their questions. Before taking services it is important to know about the service process and its advantages or disadvantages. Here is some questions and answers we set as standard.</p>
        ...
        <div style={{ display : "flex"}}>
            <div>
            <img src="https://images.pexels.com/photos/7836578/pexels-photo-7836578.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" 
